      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              child: Text('Get Voucher'),
              onPressed: () {
                // Truy cập instance của GameController
                final gameController = GameController.instance;
                resetGame();
                // Lấy giá trị từ GameController
                final eventName = gameController.eventName;
                final endDate = gameController.endDate;
                final gameId = gameController.gameId;
                final eventId = gameController.eventId;
                final gameName = gameController.gameName;                
                player.stop();               
                // Thực hiện chuyển trang và truyền giá trị vào GetVoucherGame
